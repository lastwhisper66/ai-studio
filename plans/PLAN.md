...
1. **配置 Tailwind CSS v4 样式** - `tailwindcss` + `@tailwindcss/vite` 已安装并配置，需完成 CSS 层面的设置
...
| 2. UI 基础 | 🔲 未开始 | Tailwind + Shadcn + 分栏布局 | Tailwind v4 CSS-first + Shadcn 兼容 |
| 3. 数据层  | 🔲 未开始 | SQLite + IPC + 对话 CRUD     | better-sqlite3 native rebuild       |
| 4. AI 核心 | 🔲 未开始 | 流式对话                     | OpenAI streaming over IPC           |
| 5. 设置    | 🔲 未开始 | API 配置页面                 | safeStorage 加密                    |
| 6. 渲染    | 🔲 未开始 | Markdown + 代码高亮          | 流式 Markdown 性能                  |
