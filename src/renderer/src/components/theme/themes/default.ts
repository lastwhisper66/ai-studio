...
export const defaultTheme: ColorTheme = {
  id: 'default',
  preview: {
    light: ['oklch(0.205 0 0)', 'oklch(0.97 0 0)', 'oklch(0.45 0.15 250)'],
    dark: ['oklch(0.985 0 0)', 'oklch(0.269 0 0)', 'oklch(0.55 0.14 250)'],
  },
  light: {
    ...
    '--chat-user': 'oklch(0.92 0 0)',
    '--chat-user-foreground': 'oklch(0.205 0 0)',
    '--nav-background': 'oklch(0.96 0 0)',
    '--nav-foreground': 'oklch(0.45 0 0)',
    '--nav-active': 'oklch(0.45 0.15 250)',
  },
  dark: {
