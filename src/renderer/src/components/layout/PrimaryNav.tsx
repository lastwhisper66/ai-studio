        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              variant="ghost"
              size="icon"
              className={cn('h-9 w-9', activeView === 'library' && 'text-nav-active')}
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              variant="ghost"
              size="icon"
              className={cn('h-9 w-9', activeView === 'mini-apps' && 'text-nav-active')}
              onClick={() => setActiveView('mini-apps')}>
              <LayoutGrid className="h-5 w-5" />
            </Button>
          </TooltipTrigger>
          <TooltipContent side="right">{t('nav.miniApps')}</TooltipContent>
        </Tooltip>
      </div>
